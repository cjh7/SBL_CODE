...
%beta0
%FR_TMSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\TMSBL');
...
%FR_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\MSBL');
...
%FR_SA_SBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\SA_SBL');
FR_SA_SBL_b0=[];
for i=[1,6,7,8,9]
...
%FR_SA_TSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\SA_TSBL');
FR_SA_TSBL_b0=[];
for i=[1,6,7,8,9]
...
%FR_SA_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\SA_MSBL');
FR_SA_MSBL_b0=[];
for i=[1,6,7,8,9]
...
%FR_LEE
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\LEE');
FR_LEE_b0=[];
for i=[1,6,7,8,9]
...
%FR_KAVEH
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\KAVEH');
...
%FR_TMSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\TMSBL');
FR_TMSBL_b99= csvread('FR_TMSBL_5.csv');
FR_TMSBL_b99_mean = mean(FR_TMSBL_b99)
FR_TMSBL_b99_std = std(FR_TMSBL_b99)
FR_TMSBL_b99_quantile = quantile(FR_TMSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%FR_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\MSBL');
FR_MSBL_b99= csvread('FR_MSBL_5.csv');
FR_MSBL_b99_mean = mean(FR_MSBL_b99)
FR_MSBL_b99_std = std(FR_MSBL_b99)
FR_MSBL_b99_quantile = quantile(FR_MSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%FR_SA_SBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\SA_SBL');
FR_SA_SBL_b99=[];
for i=[5,22,23,24,25]
filename=sprintf('FR_SA_SBL_%d.csv', i);
FR_SA_SBL=csvread(filename);
FR_SA_SBL_b99=[FR_SA_SBL_b99;FR_SA_SBL];
end
FR_SA_SBL_b99=reshape(FR_SA_SBL_b99.',1,[]);
FR_SA_SBL_b99_mean = mean(FR_SA_SBL_b99)
FR_SA_SBL_b99_std = std(FR_SA_SBL_b99)
FR_SA_SBL_b99_quantile = quantile(FR_SA_SBL_b99,[0.025,0.25 0.5 0.75,0.975])
%FR_SA_TSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\SA_TSBL');
FR_SA_TSBL_b99=[];
for   i=[5,22,23,24,25]
filename=sprintf('FR_SA_TSBL_%d.csv', i);
FR_SA_TSBL=csvread(filename);
FR_SA_TSBL_b99=[FR_SA_TSBL_b99;FR_SA_TSBL];
end
FR_SA_TSBL_b99=reshape(FR_SA_TSBL_b99.',1,[]);
FR_SA_TSBL_b99_mean = mean(FR_SA_TSBL_b99)
FR_SA_TSBL_b99_std = std(FR_SA_TSBL_b99)
FR_SA_TSBL_b99_quantile = quantile(FR_SA_TSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%FR_SA_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\SA_MSBL');
FR_SA_MSBL_b99=[];
for  i=[5,22,23,24,25]
filename=sprintf('FR_SA_MSBL_%d.csv', i);
FR_SA_MSBL=csvread(filename);
FR_SA_MSBL_b99=[FR_SA_MSBL_b99;FR_SA_MSBL];
end
FR_SA_MSBL_b99=reshape(FR_SA_MSBL_b99.',1,[]);
FR_SA_MSBL_b99_mean = mean(FR_SA_MSBL_b99)
FR_SA_MSBL_b99_std = std(FR_SA_MSBL_b99)
FR_SA_MSBL_b99_quantile = quantile(FR_SA_MSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%FR_LEE
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\LEE');
FR_LEE_b99=[];
for  i=[5,22,23,24,25]
filename=sprintf('FR_LEE_%d.csv', i);
FR_LEE=csvread(filename);
FR_LEE_b99=[FR_LEE_b99;FR_LEE];
end
FR_LEE_b99=reshape(FR_LEE_b99.',1,[]);
FR_LEE_b99_mean = mean(FR_LEE_b99)
FR_LEE_b99_std = std(FR_LEE_b99)
FR_LEE_b99_quantile = quantile(FR_LEE_b99,[0.025,0.25 0.5 0.75,0.975])
%FR_KAVEH
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\FR\KAVEH');
FR_KAVEH_b99= csvread('FR_KAVEH_5.csv');
FR_KAVEH_b99_mean = mean(FR_KAVEH_b99)
FR_KAVEH_b99_std = std(FR_KAVEH_b99)
FR_KAVEH_b99_quantile = quantile(FR_KAVEH_b99,[0.025,0.25 0.5 0.75,0.975])


%result 5_1
%beta0
%NMSE_TMSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\TMSBL');
...
%NMSE_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\MSBL');
...
%NMSE_SA_SBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\SA_SBL');
NMSE_SA_SBL_b0=[];
for i=[1,6,7,8,9]
...
%NMSE_SA_TSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\SA_TSBL');
NMSE_SA_TSBL_b0=[];
for i=[1,6,7,8,9]
...
%NMSE_SA_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\SA_MSBL');
NMSE_SA_MSBL_b0=[];
for i=[1,6,7,8,9]
...
%NMSE_LEE
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\LEE');
NMSE_LEE_b0=[];
for i=[1,6,7,8,9]
...
%NMSE_KAVEH
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\KAVEH');
...
%NMSE_TMSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\TMSBL');
NMSE_TMSBL_b99= csvread('NMSE_TMSBL_5.csv');
NMSE_TMSBL_b99_mean = mean(NMSE_TMSBL_b99)
NMSE_TMSBL_b99_std = std(NMSE_TMSBL_b99)
NMSE_TMSBL_b99_quantile = quantile(NMSE_TMSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%NMSE_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\MSBL');
NMSE_MSBL_b99= csvread('NMSE_MSBL_5.csv');
NMSE_MSBL_b99_mean = mean(NMSE_MSBL_b99)
NMSE_MSBL_b99_std = std(NMSE_MSBL_b99)
NMSE_MSBL_b99_quantile = quantile(NMSE_MSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%NMSE_SA_SBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\SA_SBL');
NMSE_SA_SBL_b99=[];
for i=[5,22,23,24,25]
filename=sprintf('NMSE_SA_SBL_%d.csv', i);
NMSE_SA_SBL=csvread(filename);
NMSE_SA_SBL_b99=[NMSE_SA_SBL_b99;NMSE_SA_SBL];
end
NMSE_SA_SBL_b99=reshape(NMSE_SA_SBL_b99.',1,[]);
NMSE_SA_SBL_b99_mean = mean(NMSE_SA_SBL_b99)
NMSE_SA_SBL_b99_std = std(NMSE_SA_SBL_b99)
NMSE_SA_SBL_b99_quantile = quantile(NMSE_SA_SBL_b99,[0.025,0.25 0.5 0.75,0.975])
%NMSE_SA_TSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\SA_TSBL');
NMSE_SA_TSBL_b99=[];
for   i=[5,22,23,24,25]
filename=sprintf('NMSE_SA_TSBL_%d.csv', i);
NMSE_SA_TSBL=csvread(filename);
NMSE_SA_TSBL_b99=[NMSE_SA_TSBL_b99;NMSE_SA_TSBL];
end
NMSE_SA_TSBL_b99=reshape(NMSE_SA_TSBL_b99.',1,[]);
NMSE_SA_TSBL_b99_mean = mean(NMSE_SA_TSBL_b99)
NMSE_SA_TSBL_b99_std = std(NMSE_SA_TSBL_b99)
NMSE_SA_TSBL_b99_quantile = quantile(NMSE_SA_TSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%NMSE_SA_MSBL
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\SA_MSBL');
NMSE_SA_MSBL_b99=[];
for  i=[5,22,23,24,25]
filename=sprintf('NMSE_SA_MSBL_%d.csv', i);
NMSE_SA_MSBL=csvread(filename);
NMSE_SA_MSBL_b99=[NMSE_SA_MSBL_b99;NMSE_SA_MSBL];
end
NMSE_SA_MSBL_b99=reshape(NMSE_SA_MSBL_b99.',1,[]);
NMSE_SA_MSBL_b99_mean = mean(NMSE_SA_MSBL_b99)
NMSE_SA_MSBL_b99_std = std(NMSE_SA_MSBL_b99)
NMSE_SA_MSBL_b99_quantile = quantile(NMSE_SA_MSBL_b99,[0.025,0.25 0.5 0.75,0.975])
%NMSE_LEE
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\LEE');
NMSE_LEE_b99=[];
for  i=[5,22,23,24,25]
filename=sprintf('NMSE_LEE_%d.csv', i);
NMSE_LEE=csvread(filename);
NMSE_LEE_b99=[NMSE_LEE_b99;NMSE_LEE];
end
NMSE_LEE_b99=reshape(NMSE_LEE_b99.',1,[]);
NMSE_LEE_b99_mean = mean(NMSE_LEE_b99)
NMSE_LEE_b99_std = std(NMSE_LEE_b99)
NMSE_LEE_b99_quantile = quantile(NMSE_LEE_b99,[0.025,0.25 0.5 0.75,0.975])
%NMSSE_KAVEH
cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\raw_result\NMSE\KAVEH');
NMSE_KAVEH_b99= csvread('NMSE_KAVEH_5.csv');
NMSE_KAVEH_b99_mean = mean(NMSE_KAVEH_b99)
NMSE_KAVEH_b99_std = std(NMSE_KAVEH_b99)
NMSE_KAVEH_b99_quantile = quantile(NMSE_KAVEH_b99,[0.025,0.25 0.5 0.75,0.975])
