...
N =12;M =33;L =1;K =3;correct_prior=0;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==2   
rng(100);
run_TMSBL =1;run_MSBL=1;run_KAVEH=1;
N =12;M =33;L =2;K =3;correct_prior=0;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==3   
rng(100);
run_TMSBL =1;run_MSBL=1;run_KAVEH=1;
N =12;M =33;L =3;K =3;correct_prior=0;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==4  
rng(100);
run_TMSBL =1;run_MSBL=1;run_KAVEH=1;
N =12;M =33;L =4;K =3;correct_prior=0;wrong_prior=0;
beta = ones(K,1)*(0.99);

elseif ii==5   
rng(100);
N =12;M =33;L =1;K =3;correct_prior=1;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==6   
rng(100);
N =12;M =33;L =1;K =3;correct_prior=2;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==7   
rng(100);
N =12;M =33;L =1;K =3;correct_prior=1;wrong_prior=1;
beta = ones(K,1)*(0.99);
elseif ii==8   
rng(100);
N =12;M =33;L =1;K =3;correct_prior=2;wrong_prior=1;
beta = ones(K,1)*(0.99);
...
elseif ii==9   
rng(100);
N =12;M =33;L =2;K =3;correct_prior=1;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==10   
rng(100);
N =12;M =33;L =2;K =3;correct_prior=2;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==11   
rng(100);
N =12;M =33;L =2;K =3;correct_prior=1;wrong_prior=1;
beta = ones(K,1)*(0.99);
elseif ii==12   
rng(100);
N =12;M =33;L =2;K =3;correct_prior=2;wrong_prior=1;
beta = ones(K,1)*(0.99);
...
elseif ii==13   
rng(100);
N =12;M =33;L =3;K =3;correct_prior=1;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==14   
rng(100);
N =12;M =33;L =3;K =3;correct_prior=2;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==15   
rng(100);
N =12;M =33;L =3;K =3;correct_prior=1;wrong_prior=1;
beta = ones(K,1)*(0.99);
elseif ii==16   
rng(100);
N =12;M =33;L =3;K =3;correct_prior=2;wrong_prior=1;
beta = ones(K,1)*(0.99);
...
elseif ii==17   
rng(100);
N =12;M =33;L =4;K =3;correct_prior=1;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==18   
rng(100);
N =12;M =33;L =4;K =3;correct_prior=2;wrong_prior=0;
beta = ones(K,1)*(0.99);
elseif ii==19   
rng(100);
N =12;M =33;L =4;K =3;correct_prior=1;wrong_prior=1;
beta = ones(K,1)*(0.99);
elseif ii==20   
rng(100);
N =12;M =33;L =4;K =3;correct_prior=2;wrong_prior=1;
beta = ones(K,1)*(0.99);
...
for n=1:20
 ...
 cd('C:\CODE\REAL_SUBMIT\result_5_2\revision\result_matrix');
