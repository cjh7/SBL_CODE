...
N =12;M =33;L =5;K =3;correct_prior=0;wrong_prior=0;
beta = ones(K,1)*(0.0);
elseif ii==2   
rng(100);
run_TMSBL=1; run_MSBL=1;run_KAVEH=1;
...
elseif ii==6  
rng(100);
N =12; M =33; L =5; K =3; correct_prior=1; wrong_prior=0;
beta = ones(K,1)*(0.0);
elseif ii==7  
rng(100);
N =12; M =33; L =5; K =3; correct_prior=2; wrong_prior=0;
beta = ones(K,1)*(0.0);
elseif ii==8  
rng(100);
N =12; M =33; L =5; K =3; correct_prior=1; wrong_prior=1;
beta = ones(K,1)*(0.0);
elseif ii==9  
rng(100);
N =12; M =33; L =5; K =3; correct_prior=2; wrong_prior=1;
beta = ones(K,1)*(0.0);
...
for n=1:25
 ...
 cd('C:\CODE\REAL_SUBMIT\result_5_1\revision\result_matrix');
