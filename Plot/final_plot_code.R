...
setwd("C:/CODE/SIMULATION_SUBMIT/result_4_1/revision/raw_result/FR/SA_TSBL")
FR_SA_TSBL_b0=c()
...
setwd("C:/CODE/SIMULATION_SUBMIT/result_4_1/revision/raw_result/NMSE/SA_TSBL")
NMSE_SA_TSBL_b0=c()
for (i in c(1,6,7,8,9,10,11,12,13)){
...
setwd("C:/CODE/SIMULATION_SUBMIT/result_4_2/revision/raw_result/FR/SA_TSBL")
FR_SA_TSBL_L2=c()
...
setwd("C:/CODE/SIMULATION_SUBMIT/result_4_2/revision/raw_result/NMSE/SA_TSBL")
NMSE_SA_TSBL_L2=c()
for (i in c(1,4,5,6,7,8,9,10,11)){
        filename=sprintf('NMSE_SA_TSBL_%d.csv', i);
        NMSE_SA_TSBL=read.csv(file=filename,header = FALSE);
...
setwd("C:/CODE/SIMULATION_SUBMIT/result_4_3/revision/raw_result/FR/SA_TSBL")
FR_SA_TSBL_M30=c()
...
setwd("C:/CODE/SIMULATION_SUBMIT/result_4_3/revision/raw_result/NMSE/SA_TSBL")
NMSE_SA_TSBL_M30=c()
for (i in c(1,5,6,7,8,9,10,11,12)){
        filename=sprintf('NMSE_SA_TSBL_%d.csv', i);
        NMSE_SA_TSBL=read.csv(file=filename,header = FALSE);
...
setwd("C:/CODE/REAL_SUBMIT/result_5_1/revision/raw_result/FR/SA_TSBL")
FR_SA_TSBL_b0=c()
...
setwd("C:/CODE/REAL_SUBMIT/result_5_1/revision/raw_result/NMSE/SA_TSBL")
NMSE_SA_TSBL_b0=c()
for (i in c(1,6,7,8,9)){
        filename=sprintf('NMSE_SA_TSBL_%d.csv', i);
        NMSE_SA_TSBL=read.csv(file=filename,header = FALSE);
...
setwd("C:/CODE/REAL_SUBMIT/result_5_2/revision/raw_result/FR/SA_TSBL")
FR_SA_TSBL_L2=c()
...
setwd("C:/CODE/REAL_SUBMIT/result_5_2/revision/raw_result/NMSE/SA_TSBL")
NMSE_SA_TSBL_L2=c()
for (i in c(2,9,10,11,12)){
        filename=sprintf('NMSE_SA_TSBL_%d.csv', i);
        NMSE_SA_TSBL=read.csv(file=filename,header = FALSE);
