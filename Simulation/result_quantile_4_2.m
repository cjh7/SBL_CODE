...
FR_TMSBL_L2= csvread('FR_TMSBL_1.csv');
...
FR_MSBL_L2= csvread('FR_MSBL_1.csv');
...
FR_KAVEH_L2= csvread('FR_KAVEH_1.csv');
...
%FR_TMSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\TMSBL');
FR_TMSBL_L3= csvread('FR_TMSBL_2.csv');
...
%FR_MSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\MSBL');
FR_MSBL_L3= csvread('FR_MSBL_2.csv');
...
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\SA_SBL');
FR_SA_SBL_L3=[];
for i=[2,12,13,14,15,16,17,18,19]
filename=sprintf('FR_SA_SBL_%d.csv', i);
FR_SA_SBL=csvread(filename);
...
%FR_KAVEH
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\KAVEH');
FR_KAVEH_L3= csvread('FR_KAVEH_2.csv');
...
%FR_TMSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\TMSBL');
FR_TMSBL_L4= csvread('FR_TMSBL_3.csv');
...
%FR_MSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\MSBL');
FR_MSBL_L4= csvread('FR_MSBL_3.csv');
...
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\SA_SBL');
FR_SA_SBL_L4=[];
for i=[3,20,21,22,23,24,25,26,27]
filename=sprintf('FR_SA_SBL_%d.csv', i);
FR_SA_SBL=csvread(filename);
...
%FR_KAVEH
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\KAVEH');
FR_KAVEH_L4= csvread('FR_KAVEH_3.csv');
...
NMSE_TMSBL_L2= csvread('NMSE_TMSBL_1.csv');
...
NMSE_MSBL_L2= csvread('NMSE_MSBL_1.csv');
...
NMSE_KAVEH_L2= csvread('NMSE_KAVEH_1.csv');
...
%NMSE_TMSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\TMSBL');
NMSE_TMSBL_L3= csvread('NMSE_TMSBL_2.csv');
...
%NMSE_MSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\MSBL');
NMSE_MSBL_L3= csvread('NMSE_MSBL_2.csv');
...
%NMSE_KAVEH
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\KAVEH');
NMSE_KAVEH_L3= csvread('NMSE_KAVEH_2.csv');
...
%NMSE_TMSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\TMSBL');
NMSE_TMSBL_L4= csvread('NMSE_TMSBL_3.csv');
...
%NMSE_MSBL
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\MSBL');
NMSE_MSBL_L4= csvread('NMSE_MSBL_3.csv');
...
%NMSE_KAVEH
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\KAVEH');
NMSE_KAVEH_L4= csvread('NMSE_KAVEH_3.csv');
