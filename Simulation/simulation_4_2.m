...
N =7;M =55;L =2;K =4;correct_prior=0;wrong_prior=0;
elseif ii==2   
rng(1155436751);
run_TMSBL = 1; run_MSBL=1;run_KAVEH=1;
N =7;M =55;L =3;K =4;correct_prior=0;wrong_prior=0;
elseif ii==3   
rng(1155436751);
run_TMSBL = 1; run_MSBL=1;run_KAVEH=1;
N =7;M =55;L =4;K =4;correct_prior=0;wrong_prior=0;


elseif ii==4   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=1;wrong_prior=0;
elseif ii==5   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=2;wrong_prior=0;
elseif ii==6   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=3;wrong_prior=0;
elseif ii==7   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=1;wrong_prior=1;
elseif ii==8   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=2;wrong_prior=1;
elseif ii==9   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=3;wrong_prior=1;
elseif ii==10   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=2;wrong_prior=2;
elseif ii==11   
rng(1155436751);
N =7;M =55;L =2;K =4;correct_prior=3;wrong_prior=2;

elseif ii==12   
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=1;wrong_prior=0;
elseif ii==13   
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=2;wrong_prior=0;
elseif ii==14   
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=3;wrong_prior=0;
elseif ii==15   
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=1;wrong_prior=1;
elseif ii==16  
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=2;wrong_prior=1;
elseif ii==17  
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=3;wrong_prior=1;
elseif ii==18   
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=2;wrong_prior=2;
elseif ii==19   
rng(1155436751);
N =7;M =55;L =3;K =4;correct_prior=3;wrong_prior=2;   


elseif ii==20   
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=1;wrong_prior=0;
elseif ii==21   
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=2;wrong_prior=0;
elseif ii==22   
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=3;wrong_prior=0;
elseif ii==23   
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=1;wrong_prior=1;
elseif ii==24  
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=2;wrong_prior=1;
elseif ii==25  
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=3;wrong_prior=1;
elseif ii==26   
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=2;wrong_prior=2;
elseif ii==27   
rng(1155436751);
N =7;M =55;L =4;K =4;correct_prior=3;wrong_prior=2;   
...
if ii==1 |ii==2 |ii==3
    cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\TMSBL');
    filename=sprintf('FR_TMSBL_%d.csv',ii);
    csvwrite(filename,fail_TMSBL);
    cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\TMSBL');
    filename=sprintf('NMSE_TMSBL_%d.csv',ii);
    csvwrite(filename,mse_TMSBL);

    cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\MSBL');
    filename=sprintf('FR_MSBL_%d.csv',ii);
    csvwrite(filename,fail_MSBL);
    cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\MSBL');
    filename=sprintf('NMSE_MSBL_%d.csv',ii);
    csvwrite(filename,mse_MSBL);
    

    cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\KAVEH');
    filename=sprintf('FR_KAVEH_%d.csv',ii);
    csvwrite(filename,fail_KAVEH);
    cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\KAVEH');
...
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\SA_TSBL');
filename=sprintf('FR_SA_TSBL_%d.csv',ii);
csvwrite(filename,fail_SA_TSBL);
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\SA_TSBL');
filename=sprintf('NMSE_SA_TSBL_%d.csv',ii);
csvwrite(filename,mse_SA_TSBL);


cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\SA_MSBL');
filename=sprintf('FR_SA_MSBL_%d.csv',ii);
csvwrite(filename,fail_SA_MSBL);
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\SA_MSBL');
filename=sprintf('NMSE_SA_MSBL_%d.csv',ii);
csvwrite(filename,mse_SA_MSBL);

cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\SA_SBL');
filename=sprintf('FR_SA_SBL_%d.csv',ii);
csvwrite(filename,fail_SA_SBL);
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\SA_SBL');
filename=sprintf('NMSE_SA_SBL_%d.csv',ii);
csvwrite(filename,mse_SA_SBL);

% 
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\FR\LEE');
filename=sprintf('FR_LEE_%d.csv',ii);
csvwrite(filename,fail_LEE);
cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\raw_result\NMSE\LEE');
...
for n=1:27
 ...
 cd('C:\CODE\SIMULATION_SUBMIT\result_4_2\revision\result_matrix');
    filename=sprintf('result_%d.csv',ii);
